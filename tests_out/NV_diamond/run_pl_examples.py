...
def execute_pipeline(
    ...
    summaries, and JSON configurations.
    """
...
if __name__ == "__main__":
    ...
    run_pl_analysis(
        data_path=DATA_DIR,
        out_path=Path(
            "/home/user/Project/ht_SiN/benchmark/NV_diamond_PL/codes/defectpl/tests_out/NV_diamond/pbe_out"
        ),
    ...
    run_pl_analysis(
        data_path=DATA_DIR,
        out_path=Path(
            "/home/user/Project/ht_SiN/benchmark/NV_diamond_PL/codes/defectpl/tests_out/NV_diamond/frac_pbe_out"
        ),
        system_dir="NV_diamond",
        dfpt_dir="dfpt",
        gs_dir="gs",
    ...
    run_pl_analysis(
        data_path=DATA_DIR,
        out_path=Path(
            "/home/user/Project/ht_SiN/benchmark/NV_diamond_PL/codes/defectpl/tests_out/NV_diamond/hse06_out"
        ),
        system_dir="NV_diamond",
        dfpt_dir="dfpt/hse06",
        gs_dir="gs/hse06",
    ...
    run_pl_analysis(
        data_path=DATA_DIR,
        out_path=Path(
            "/home/user/Project/ht_SiN/benchmark/NV_diamond_PL/codes/defectpl/tests_out/NV_diamond/frac_hse06_out"
        ),
        system_dir="NV_diamond",
        dfpt_dir="dfpt/hse06",
        gs_dir="gs/hse06",
